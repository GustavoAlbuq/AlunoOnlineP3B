...
public class MatriculaAlunoService {
    ...
    public void trancarMatricula(Long idMatricula) {
        MatriculaAluno matriculaAluno = matriculaAlunoRepository.findById(idMatricula)
    ...
    public void atualizarNotas(AtualizarNotasRequestDTO request, Long idMatricula) {
        System.out.println("Recebendo atualização de notas para matrícula: " + idMatricula);
        System.out.println("Notas recebidas: nota1 = " + request.getNota1() + ", nota2 = " + request.getNota2());
